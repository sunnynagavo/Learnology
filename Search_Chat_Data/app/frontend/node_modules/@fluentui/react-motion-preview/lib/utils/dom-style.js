 ...
 */ export const getElementComputedStyle = (node)=>{
    ...
    const win = canUseDOM() && ((_node_ownerDocument_defaultView = (_node_ownerDocument = node.ownerDocument) === null || _node_ownerDocument === void 0 ? void 0 : _node_ownerDocument.defaultView) !== null && _node_ownerDocument_defaultView !== void 0 ? _node_ownerDocument_defaultView : window);
    if (!win) {
        return {
            getPropertyValue: (_)=>''
        };
